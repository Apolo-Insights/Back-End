...
public interface UsuarioMapper {
    ...
    AtualizarUsuarioCommand atualizacaoToCommand(DadosAtualizacaoUsuario dados);
    DadosDetalhamentoUsuario usuarioToDetalhamento(Usuario usuario);
    
    @Mapping(source = "role", target = "funcao")
    DadosListagemUsuario usuarioToListagem(Usuario usuario);
